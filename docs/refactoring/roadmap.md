...
Status: `IN_PROGRESS` — `HARD-01` completed in production on 2026-09-23
([PR #76](https://github.com/all1son4/dance-course-fe/pull/76), CI and deployment
smoke passed). The shared-password flow is unchanged; no environment or database
settings changed. Continue with `HARD-02`.
...
| 2026-09-23 | HARD-01 shared login UX     | `DONE`        | One password kept; prod PR #76, CI and smoke green                       |
