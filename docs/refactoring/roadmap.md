...
Status: `IN_PROGRESS`. Both admin invite POST routes now use one explicit grant
...
intentionally unchanged until `READ-05`. Final status awaits exact-revision Quality
and deployed development smoke evidence.
...
| 2026-08-13 | WRITE-05 implementation     | `IN_PROGRESS` | Atomic admin grants; local acceptance in progress             |
