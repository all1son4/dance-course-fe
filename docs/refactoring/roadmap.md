...
Status: `IN_PROGRESS` — `HARD-01` narrowed with owner approval on 2026-09-23.
The shared-password login/logout improvements are verified in dev; production PR
is pending. No environment or database settings have changed.
...
| 2026-09-23 | HARD-01 shared login UX     | `DEV VERIFIED` | One password kept; 230 unit, 2 mocked browser, CI/smoke green            |
